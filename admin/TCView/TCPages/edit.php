                        ...
                        <h2 class="ui header">
                          <?= $page->title ?>
                            <div class="sub header grey">
                              <?php echo $baseUrl . '/page/' . \Engine\TCHelper\TCText::transliteration($page->title) ?>
                            </div>
                        </h2>
                    </div>
                </div>
                    ...
                    <form id="formPage" class="ui form">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="title" class="form-control"
                                   id="formTitle" value="<?= $page->title ?>"
                                   placeholder="Title page...">
                        </div>
                        <div class="field">
                            <label for="redactor">Content</label>
                            <textarea name="content"
                                      id="redactor"><?= $page->content ?></textarea>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="ui form segment">
                            <div class="field">
                                ...
                                <select id="status" class="ui search dropdown">
                                    <option value="publish"<?php if ('publish' == $page->status) {
                                      echo ' selected';
                                    } ?>>Опубликовано
                                    </option>
                                    <option value="draft"<?php if ('draft' == $page->status) {
                                      echo ' selected';
                                    } ?>>В корзине
                                    </option>
                                </select>
                        ...
                        <div class="ui form segment">
                            <div class="field">
                                ...
                                <select id="type" class="ui search dropdown">
                                  ...
                                  <?php foreach (TCFunctionGetTypes('page') as $key => $type): ?>
                                      <option value="<?php echo $key ?>"<?php if ($key == $page->type) {
                                        echo ' selected';
                                      } ?>>
                                        <?php echo $type ?>
                                      </option>
